...
/*
* A class to wrap the InvoiceShipping database object
*
*
*/
class InvoiceShipping extends DAO {

	var $orderId;	/* Not NULL */
	var $name;	/* Not NULL */
	var $cost;	/* Not NULL */
	var $expectedDaysTaken; //NOT NULL
	
	function InvoiceShipping(&$config) {
        parent::DAO($config);
		$this->table = "InvoiceShipping";
		$this->fields = Array('orderId', 'name', 'cost', 'expectedDaysTaken');
	}
	...
	function validate() {
		...
		elseif ( !$this->cost || (""== trim($this->cost)) ) {
			$result = "cost";
		}
