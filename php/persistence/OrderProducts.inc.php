...
/*
* A class to wrap the OrderProducts database object
* Needs to be refactored into the InvoiceItem class
*
*/
class OrderProducts extends DAO {

	var $orderId;	/* Not NULL */
	var $productId;	/* Not NULL */
	var $number;	/* Not NULL */ 
	
	function OrderProducts(&$config) {
        parent::DAO($config);
		$this->table = "OrderProducts";
		$this->fields = Array("orderId", "productId", "number");
	}
	...
	function validate() {
		...
		elseif ( !$this->productId || (""== trim($this->productId)) ) {
			$result = "productId";
		}
